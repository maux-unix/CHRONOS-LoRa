...
// TODO: Implement --help and other CLI flags/options
...
main(int argc, char **argv)
{
    ...
    printf("[CRC-INFO] final-crc = 0x%08X\n", crc);
    ...
    // Contoh konversi ke PPM
    chronos_convert_to_ppm("signatureedits/DSC02363.ARW", "DSC02363.PPM");

    // Contoh resize image
    chronos_resize_image("DSC02363.PPM", "DSC02363_resized.PPM");
    return 0;
}
